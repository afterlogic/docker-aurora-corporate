...
[Afterlogic Aurora Corporate](https://afterlogic.com/aurora) image for Docker using Nginx, PHP-FPM 8.3, MySQL on Alpine Linux. Loosely based on [khromov/alpine-nginx-php8 package](https://github.com/khromov/alpine-nginx-php8).
